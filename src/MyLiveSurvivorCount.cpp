/**
 * Декомпільований та модифікований код з гри Left 4 Dead.
 * Модифікація полягає у добавленні перевірки на те чи гравець має таблетки чи ні
 * при підрахунку живих вцілілих у функції LiveSurvivorCount, щоб використовувати разом з плагіном SelfHelp.
 * Автор модифікацій: DenMarko.
 */
